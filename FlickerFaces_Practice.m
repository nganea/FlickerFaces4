...
if nargin < 3 || isempty(PC) == 1
    PC = 1; % 2 = Haskins laptop; 1 = Desk screen; 0 = Haskins EEG
end
...
instr2 = {'Remember \n\n',...
    ...
    '2) cartoon swings >> press SPACEBAR \n\n',...
...
for ss = 1:nbSeq
    ...
    % AttGet
    [~,endPract] = FlickerFaces_AttGet(w, wrect, back, [], ...
